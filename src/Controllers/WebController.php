...
final class WebController {
    ...
    public function documentForm():void{Auth::require();$type=(string)($_GET['type']??'invoice');$allowed=['invoice','proforma','offer','order','credit'];if(!in_array($type,$allowed,true))$type='invoice';View::render('documents/form',['title'=>'Nový doklad','customers'=>$this->customersList(),'products'=>$this->productsList(),'prefillDocType'=>$type]);}

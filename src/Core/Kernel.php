...
final class Kernel {
    public static function handle(): void {
        ...
        $r->get('/expenses',fn()=> $w->expenses()); $r->get('/received-invoices',fn()=> $w->receivedInvoices()); $r->post('/received-invoices/save',fn()=> $w->receivedInvoiceSave()); $r->post('/received-invoices/{id}/paid',fn($id)=>$w->receivedInvoicePaid((int)$id)); $r->post('/expenses/save',fn()=> $w->expenseSave());

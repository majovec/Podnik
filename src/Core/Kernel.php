...
final class Kernel {
    public static function handle(): void {
        ...
        $r->get('/documents',fn()=> $w->documents()); $r->get('/documents/new',fn()=> $w->documentForm()); $r->get('/documents/create',fn()=> $w->documentForm()); $r->get('/invoice/new',fn()=> $w->documentForm()); $r->post('/documents/save',fn()=> $w->documentSave()); $r->get('/documents/{id}/pdf',fn($id)=>$w->pdf((int)$id));

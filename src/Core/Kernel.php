...
final class Kernel {
    public static function handle(): void {
        ...
        $r->get('/tasks',fn()=> $w->tasks()); $r->post('/tasks/save',fn()=> $w->taskSave()); $r->post('/tasks/{id}/done',fn($id)=>$w->taskDone((int)$id)); $r->get('/recurring',fn()=> $w->recurring()); $r->post('/recurring',fn()=> $w->recurringSave()); $r->get('/tax',fn()=> $tax->index()); $r->post('/tax',fn()=> $w->taxSave()); $r->get('/export',fn()=> $w->export()); $r->get('/accounting/export',fn()=> $accounting->export()); $r->get('/accountant/{token}',fn($token)=>$w->accountantPortal((string)$token)); $r->get('/received-invoices',fn()=> $received->index()); $r->post('/received-invoices/save',fn()=> $received->save()); $r->post('/accountant/share',fn()=> $w->accountantShare()); $r->get('/gdpr/export',fn()=> $w->gdprExport()); $r->post('/gdpr/export',fn()=> $w->gdprExport()); $r->get('/documents/{id}/isdoc',fn($id)=>$w->isdoc((int)$id)); $r->post('/isdoc/import',fn()=> $w->isdocImport()); $r->get('/automation',fn()=> $w->automation()); $r->post('/automation/save',fn()=> $w->automationSave());

...
.dash-recommendations{display:grid;grid-template-columns:1.35fr .9fr;gap:16px;margin-top:16px}.nia-chip{display:inline-flex;align-items:center;padding:5px 9px;border-radius:999px;background:#f0edff;color:#5946e8;font-size:10px;font-weight:900}.reco-list{display:grid;gap:8px}.reco-item{display:flex;gap:10px;align-items:flex-start;padding:10px 11px;border:1px solid #e7edf5;border-radius:11px;background:#fbfcfe;font-size:11px;line-height:1.45}.reco-item>span{color:#5946e8;font-weight:900}.quick-actions{display:grid;grid-template-columns:1fr 1fr;gap:8px}.quick-actions a{border:1px solid #e5ebf3;border-radius:11px;padding:11px;font-size:11px;font-weight:800;background:#fff}.quick-actions a:hover{border-color:#bcd1eb;background:#f8fbff}.dash-recommendations{grid-template-columns:1.35fr .9fr}.dash-kpis{grid-template-columns:repeat(2,1fr)}.dash-main-grid,.dash-three-grid,.dash-two-grid,.dash-recommendations{grid-template-columns:1fr}.tool-grid{grid-template-columns:repeat(3,1fr)}}

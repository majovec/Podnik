...
?>
<div class="dashboard-ref" data-dashboard-build="2026.09.22-r43">
  ...
  <div class="dash-ref-mobile">
    ...
    <a class="mobile-module" href="/documents"><span class="mobile-module-icon blue"><img src="/assets/dashboard-icons/invoices.svg" alt=""></span><div><b>Faktury</b><small><?=number_format($newInvoiceCount,0,',',' ')?> <?= $newInvoiceCount===1?'nová':'nových' ?> tento měsíc</small></div><strong><?=\App\Core\View::money($monthRevenue)?></strong><span class="arrow">›</span></a>
    <a class="mobile-module" href="/tasks"><span class="mobile-module-icon violet"><img src="/assets/dashboard-icons/tasks.svg" alt=""></span><div><b>Úkoly</b><small><?=count($todayTasks??[])?> otevřené</small></div><span class="arrow">›</span></a>
    <a class="mobile-module" href="/calendar"><span class="mobile-module-icon cyan"><img src="/assets/dashboard-icons/calendar.svg" alt=""></span><div><b>Kalendář</b><small><?=count($events??[])?> událostí</small></div><span class="arrow">›</span></a>
    <a class="mobile-module" href="/bank"><span class="mobile-module-icon navy"><img src="/assets/dashboard-icons/bank.svg" alt=""></span><div><b>Bankovní účty</b><small>Pohyby tento měsíc</small></div><strong><?=\App\Core\View::money($monthPaid)?></strong><span class="arrow">›</span></a>
    <a class="mobile-module" href="/customers"><span class="mobile-module-icon green"><img src="/assets/dashboard-icons/customers.svg" alt=""></span><div><b>Zákazníci</b><small><?=number_format($customersCount,0,',',' ')?> v CRM</small></div><span class="arrow">›</span></a>

...
<div class="dashboard-ref" data-dashboard-build="2026.09.22-r36">
  <div class="dash-ref-desktop">
    ...
    <section class="dash-ref-kpis">
      <a href="/documents" class="ref-kpi"><small>Faktury</small><strong><?=View::money($monthRevenue)?></strong><span class="up">↗ 12 %</span></a>
      <a href="/documents?type=invoice" class="ref-kpi"><small>Pohledávky</small><strong><?=View::money($receivables)?></strong><span class="up">↗ 8 %</span></a>
      <a href="/jobs" class="ref-kpi"><small>Zakázky</small><strong><?=number_format($jobsCount,0,',',' ')?></strong><span class="up">↗ 3 %</span></a>
      <a href="/customers" class="ref-kpi"><small>Zákazníci</small><strong><?=number_format($customersCount,0,',',' ')?></strong><span class="up">↗ 5 %</span></a>
    </section>
  ...
  <div class="dash-ref-mobile">
    ...
    <a class="mobile-module" href="/documents"><span class="mobile-module-icon blue">▣</span><div><b>Faktury</b><small><?=number_format($invoiceCount,0,',',' ')?> <?= $invoiceCount===1?'nová':'nových' ?></small></div><strong><?=View::money($monthRevenue)?></strong><span class="arrow">›</span></a>
    ...
    <a class="mobile-module" href="/bank"><span class="mobile-module-icon navy">▣</span><div><b>Bankovní účty</b><small>Aktuální stav účtů</small></div><strong><?=View::money($monthPaid)?></strong><span class="arrow">›</span></a>

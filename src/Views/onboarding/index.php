...
.guide-kicker{display:block!important;visibility:visible!important;opacity:1!important;font-size:11px;line-height:1.2;letter-spacing:.11em;color:#1677ee;font-weight:900;margin:0 0 6px}.guide-dialog .guide-copy{display:block!important;visibility:visible!important;opacity:1!important}.guide-dialog .guide-title{display:block!important;visibility:visible!important;opacity:1!important;font-size:18px;line-height:1.25;letter-spacing:-.02em;margin:0 0 6px;color:#182c50;font-weight:850}.guide-dialog .guide-text{display:block!important;visibility:visible!important;opacity:1!important;color:#526783;line-height:1.48;margin:0;font-size:14px;font-weight:500}.guide-actions{display:flex!important;visibility:visible!important;opacity:1!important;gap:7px;flex-wrap:nowrap;margin-top:12px}.guide-actions .btn{display:inline-flex!important;visibility:visible!important;opacity:1!important;cursor:pointer;flex:1;text-align:center;min-height:40px;padding:9px 8px;border-radius:12px;text-decoration:none}.guide-actions form{flex:1;display:flex!important}.guide-actions form .btn{width:100%}.guide-progress{display:flex!important;visibility:visible!important;opacity:1!important;gap:3px;margin-top:11px;flex-wrap:wrap}.guide-progress i{display:block!important;width:17px;height:4px;border-radius:99px;background:#dfe6ef}.guide-progress i.active{background:linear-gradient(90deg,#1677ee,#5946e8)}
...
<div class="guide-intro">
  ...
  <section class="guide-dialog" role="dialog" aria-modal="true" aria-labelledby="guideTitle">
    ...
    <div class="guide-copy">
      <div class="guide-title" id="guideTitle"><?=View::e($current['title'])?></div>
      <div class="guide-text"><?=View::e($current['text'])?></div>
    </div>
